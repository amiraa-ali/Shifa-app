...
//                     ),
//                     child: const Center(
//                       child: Icon(Icons.lock_open, size: 40, color: Colors.teal),
//                     ),
//                   ),
...
//                           child: Text(passwordError!, style: const TextStyle(color: Colors.red, fontSize: 13)),
//                         ),
//                     ],
//                   ),
...
//                         Padding(
//                           padding: const EdgeInsets.only(top: 5),
//                           child: Text(confirmError!, style: const TextStyle(color: Colors.red, fontSize: 13)),
//                         ),
//                     ],
//                   ),
//                   const SizedBox(height: 15),
...
//                       text: 'Must be at least 8 characters', isValid: hasMinLength, color: Colors.teal),
//                   const SizedBox(height: 8),
//                   _buildPasswordRequirement(
//                       text: 'Must contain one special character', isValid: hasSpecialChar, color: Colors.teal),
//                   const SizedBox(height: 15),
...
//   Widget _buildPasswordRequirement({required String text, required bool isValid, required Color color}) {
//     return Row(
//       children: [
//         Container(
//           width: 20,
...
//           ),
//           child: Icon(Icons.check, size: 14, color: isValid ? Colors.white : Colors.transparent),
//         ),
